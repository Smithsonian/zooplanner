				...
				<form>
					<div className="row">
						...
						<div className="col-5" id='filterlabel'>
							<label><input type='checkbox' id='exhibits' name='filter' value='exhibits' onClick={this.props.updateCheckbox} />&nbsp;&nbsp;&nbsp;&nbsp;EXHIBITS <img src="https://www.google.com.au/maps/vt/icon/name=assets/icons/spotlight/spotlight_pin_v2_shadow-1-small.png,assets/icons/spotlight/spotlight_pin_v2-1-small.png,assets/icons/spotlight/spotlight_pin_v2_dot-1-small.png,assets/icons/spotlight/spotlight_pin_v2_accent-1-small.png&highlight=93FF95,C34D57,960a0a,ffffff&color=93FF95?scale=0.5"/></label>
						</div>
					</div>

					<div className="row">
						<div className="col-6" id='filterlabel'>
							<label><input type='checkbox' id='attractions' name='filter' value='attractions' onClick={this.props.updateCheckbox} />&nbsp;&nbsp;&nbsp;&nbsp;ATTRACTIONS <img src="https://www.google.com.au/maps/vt/icon/name=assets/icons/spotlight/spotlight_pin_v2_shadow-1-small.png,assets/icons/spotlight/spotlight_pin_v2-1-small.png,assets/icons/spotlight/spotlight_pin_v2_dot-1-small.png,assets/icons/spotlight/spotlight_pin_v2_accent-1-small.png&highlight=93FF95,F18B30,960a0a,ffffff&color=93FF95?scale=0.5"/></label>	
						</div>
						<div className="col-5" id='filterlabel'>
